...
export const treatments = [
  {
    ...
    pricing: {
      ...
      packages: [
        { label: "Cijele ruke", price: 300 },
        { label: "Cijele noge", price: 400 },
        { label: "Bikini + prepone", price: 350 },
        { label: "Pazusi", price: 300 },
        { label: "Pazusi + bikini", price: 500 },
        { label: "Cijelo tijelo", price: 900 },
      ],
    },
    steps: [
      {
